...
#define CARGO_COMPANY_DELTA_ARSENAL (1<<10) // FLUFFY FRONTIER ADD: DELTA ARSENAL IMPORTS
...
#define DELTA_ARSENAL_NAME "Delta Arsenal" // FLUFFY FRONTIER ADD: DELTA ARSENAL IMPORTS
